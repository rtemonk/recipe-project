...
import rtemonk.springframework.recipeproject.converters.IngredientCommandToIngredient;
import rtemonk.springframework.recipeproject.converters.IngredientToIngredientCommand;
import rtemonk.springframework.recipeproject.models.Ingredient;
...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand findByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
        ...
        Optional<IngredientCommand> ingredientCommandOptional = recipe.getIngredients().stream()
                ...
                .map(source -> ingredientToIngredientCommand.convert(source)).findFirst();
