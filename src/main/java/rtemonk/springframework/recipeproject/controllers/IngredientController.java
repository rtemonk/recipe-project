...
import rtemonk.springframework.recipeproject.services.IngredientService;
import rtemonk.springframework.recipeproject.services.RecipeService;
import rtemonk.springframework.recipeproject.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String deleteIngredient(@PathVariable String recipeId,
        ...
        log.debug("Updated Recipe with id: " + recipeId);
        log.debug("Deleted Ingredient by id: " + id);
